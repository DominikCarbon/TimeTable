...
public class StackedBarChart1 extends ApplicationFrame {
 ...
 "Emploi du Temps", "Category", "Heure", dataset,
  PlotOrientation.VERTICAL, true, true, false);

  chart.setBackgroundPaint(new Color(11, 216, 196));
...
//Modification sur les batons du diagramme

  renderer.setItemMargin(0.0);
  Paint p1 = new GradientPaint(
  0.0f, 0.0f, new Color(250, 89, 172), 0.0f, 0.0f, new 
     Color(201, 201, 244));
  ...
  SubCategoryAxis domainAxis = 
   new SubCategoryAxis("Product / Month");
 ...
 new Rectangle(10, 10), new GradientPaint(0.0f, 0.0f,
  ...
  final StackedBarChart1 demo = 
    new StackedBarChart1("Emploi du Temps");
  demo.pack();
