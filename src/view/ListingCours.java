...
public class ListingCours extends JFrame {
 ...
 // private ArrayList<Seance> Seances;
  ...
  public ListingCours(String[][] edt,int Identifiant, String Nom, int compteur){
    ...
    this.setTitle("Ensemnle des cours");
    ...
    String  title[] = {"Matières","Plage Horaire", "Semaine", "Site", "Salle","Nb d'heures"};
